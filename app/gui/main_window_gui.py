...
class Ui_widget(object):
    def setupUi(self, widget):
        ...
        self.info_error = QtWidgets.QLabel(widget)
        self.info_error.setGeometry(QtCore.QRect(640, 260, 300, 20))
        self.info_error.setObjectName("info_error")
        ...
        self.info_rating.setGeometry(QtCore.QRect(653, 320, 85, 20))
        self.info_rating.setObjectName("info_rating")
        self.info_description = QtWidgets.QLabel(widget)
        self.info_description.setGeometry(QtCore.QRect(595, 460, 135, 20))
        self.info_description.setObjectName("info_description")
        self.info_genres = QtWidgets.QLabel(widget)
        self.info_genres.setGeometry(QtCore.QRect(652, 380, 85, 20))
        self.info_genres.setObjectName("info_genres")
        self.info_year = QtWidgets.QLabel(widget)
        self.info_year.setGeometry(QtCore.QRect(674, 350, 57, 20))
        self.info_year.setObjectName("info_year")
        self.rating_place = QtWidgets.QLabel(widget)
        self.rating_place.setGeometry(QtCore.QRect(735, 320, 205, 20))
        self.rating_place.setText("")
        self.rating_place.setObjectName("rating_place")
        self.genres_place = QtWidgets.QTextBrowser(widget)
        self.genres_place.setGeometry(QtCore.QRect(598, 410, 337, 40))
        self.genres_place.setObjectName("description_place")
        self.description_place = QtWidgets.QTextBrowser(widget)
        self.description_place.setGeometry(QtCore.QRect(598, 490, 337, 320))
        self.description_place.setObjectName("description_place")
        self.year_place = QtWidgets.QLabel(widget)
        self.year_place.setGeometry(QtCore.QRect(735, 349, 200, 20))
    ...
    def retranslateUi(self, widget):
        ...
        widget.setWindowTitle(_translate("widget", "list-of-films-and-serials"))
        ...
        self.info_error.setText(_translate("widget", ""))
